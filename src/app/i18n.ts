...
export const copy = {
  ko: {
    ...
    community: {
      ...
      earlyLabel: "EARLY ACCESS · 뉴스레터 준비 중",
      earlyHeading: "시작 소식을 먼저 받아보세요.",
      earlyBody: "NEICA의 글과 앞으로의 모임 소식을 이메일로 전하겠습니다. 지금은 발행 전 사전 등록을 받고 있습니다.",
      emailLabel: "이메일 주소",
      emailPlaceholder: "you@example.com",
      consent: "이메일을 뉴스레터 시작 안내와 NEICA의 글·모임 소식 발송에 사용하는 데 동의합니다. 구독 취소 또는 삭제 요청 시까지 보관하며, 언제든 neica.labs@gmail.com으로 삭제를 요청할 수 있습니다.",
      submit: "사전 등록하기",
      submitting: "등록 중…",
  ...
  en: {
    ...
    community: {
      ...
      earlyLabel: "EARLY ACCESS · NEWSLETTER IN PREPARATION",
      earlyHeading: "Hear when we begin.",
      earlyBody: "We will send NEICA's writing and future gathering updates by email. Early registration is open before the first issue.",
      emailLabel: "Email address",
      emailPlaceholder: "you@example.com",
      consent: "I agree to receive the newsletter launch notice, NEICA writing, and gathering updates by email. My address will be kept until I unsubscribe or request deletion at neica.labs@gmail.com.",
      submit: "Register early",
